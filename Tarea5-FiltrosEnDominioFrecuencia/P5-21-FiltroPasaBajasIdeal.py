...
imgNames = ['newspaper_shot_woman.tif','car_newsprint.tif', 'Ruido Periodico 1.jpg', 'Ruido Periodico 2.tif']
...
for i in range(0, len(imgNames)):
    ...
    cv2.createTrackbar('frec', winTitle,10,100, pb_ideal_filter)
    cv2.waitKey(0)
